...
export async function POST(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    statusUrl.pathname = "/api/meta/data-deletion/status";
    statusUrl.search = "";
    ...
    console.error("[meta/data-deletion] Request handling failed", error);
    return NextResponse.json(
  ...
  return NextResponse.json(
    {
      status: "ok",
      message:
        "Meta data deletion callback endpoint is active. POST signed_request to initiate deletion.",
    },
    { status: 200 },
  );
}
